...
namespace FerreteriaSL.RegistroVentas
{
    public partial class CajasVerFactura : Form
    {
        ...
        {
            InitializeComponent();
            _windowHeightFill = GetOsFriendlyName().Contains("XP") ? 56 : 70;
        ...
        private void LoadDataGrid(int ventasCajaId)
        {
            ...
            foreach (DataGridViewColumn sColumn in dgv_factura.Columns.Cast<DataGridViewColumn>().Where(sColumn => sColumn.Name != "Articulo"))
            {
